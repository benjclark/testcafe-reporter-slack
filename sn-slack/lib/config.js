...
var defaultConfig = {
  ...
  loggingLevel: process.env.TESTCAFE_SLACK_LOGGING_LEVEL || _LoggingLevels["default"].TEST,
...
var config = _objectSpread(_objectSpread({}, defaultConfig), reporterConfig.options);
